...
"""
    def compile(self):
        ...
        # WORKAROUND NASTY PROBLEM WITH PYREX cimport: NO WAY TO TELL IT MODULE IS
        # IN A SUBDIRECTORY!  I.E. from pygr cimport cdict FAILS, AS DOES cimport pygr.cdict
        # INSTEAD WE HAVE TO SAY cimport cdict
        import sys
        import os.path
        from pygr import cdict
        sys.path+=[os.path.dirname(cdict.__file__)] # SO WE HAVE TO ADD ITS LOCATION TO OUR PATH
